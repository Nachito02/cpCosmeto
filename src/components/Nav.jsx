...
const Nav = () => {
  ...
  return (
    <div className="bg-white " onMouseLeave={handleHoverExit}>
      <div className="flex  justify-between md:justify-evenly lg:justify-center items-center px-5 md:px-3">
        <Image
        ...
        />
        <button onClick={openModal} className="flex items-center justify-center p-2 lg:hidden ">
          <svg
            className="w-6 h-6"
            fill="none"
            stroke="currentColor"
